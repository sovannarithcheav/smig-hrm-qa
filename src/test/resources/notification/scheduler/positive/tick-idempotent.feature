...
Feature: NT-SCH-002 Two ticks in the same day fire only once
  ...
  Background:
    ...
    * def upserted = call read('classpath:notification/scheduler/helper/upsert-date.feature') { employeeId: 4243, employeeName: 'QA Idem', dateKind: 'QA_IDEMPOTENT', targetDate: '#(in3)' }
